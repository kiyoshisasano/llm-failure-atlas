...
CALIBRATION_PATH = Path(LEARNING_DIR) / "calibration_history.json"
FIX_EFFECTIVENESS_PATH = Path(LEARNING_DIR) / "fix_effectiveness.json"
SUGGESTIONS_PATH = Path(LEARNING_DIR) / "suggestions.json"
