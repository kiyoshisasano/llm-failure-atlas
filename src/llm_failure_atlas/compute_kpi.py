...
_learning = str(get_learning_dir())
LEARNING_DIR = os.environ.get("ATLAS_LEARNING_DIR", _learning)
...
# Validation errors — not bundled in package resources, expected at runtime
